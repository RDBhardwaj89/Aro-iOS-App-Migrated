...
// 5. Purpose: Master Data Seeder using PetConstants and 100% folder parity for all 15 subfolders.
...
class SetupManager {
    static func seed(context: ModelContext) {
        ...
        if (try? context.fetchCount(FetchDescriptor<FoodMetadata>())) == 0 {
            let f = [
                FoodMetadata(id: 1, name: "Burger", file: "Food/burger.png", isVeg: false), FoodMetadata(id: 2, name: "Apple", file: "Food/apple.png", isVeg: true),
                FoodMetadata(id: 3, name: "Meat", file: "Food/meat.png", isVeg: false), FoodMetadata(id: 4, name: "Bone", file: "Food/bone.png", isVeg: false),
                FoodMetadata(id: 5, name: "Fish", file: "Food/fish.png", isVeg: false), FoodMetadata(id: 6, name: "Eggs", file: "Food/egg.png", isVeg: false),
                FoodMetadata(id: 7, name: "Berries", file: "Food/berries.png", isVeg: true), FoodMetadata(id: 8, name: "Grass", file: "Food/grass.png", isVeg: true),
                FoodMetadata(id: 9, name: "Water", file: "Food/water.png", isVeg: true)
            ]
            for item in f { context.insert(item) }
